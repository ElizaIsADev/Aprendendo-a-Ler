let dados=[
    ...
    },
    {
        ...
        descricao:`<p class="descricao-meta">Confesso que não fui uma criança muito leitora. Venho aprendendo a ler há pouco tempo e decidi usar esse tema como projeto, pois acredito que outras pessoas também estão tentando ler mais e incluir a leitura em suas vidas. Pessoal, leitura é vida, é fonte de energia, é fonte de conhecimento! Voltando à ideia central, deixarei aqui algumas dicas para tornar suas horas de leitura mais agradáveis e proveitosas:
        </p>
        <p class="descricao-meta"><b>Dica 1: Escolha um local</b></p>
        <p class="descricao-meta">Sim, é muito importante escolher um local para iniciar a leitura. Pode ser desde o seu quarto até um banco na praça. Apenas reserve um espaço para isso. </b></p>
        <p class="descricao-meta"><b>Dica 2: Defina o tempo/meta</b></p>
        <p class="descricao-meta">Para os iniciantes desse novo mundo, recomendo definir um tempo ou meta, por exemplo: fazer uma leitura por 30 minutos ou ler três páginas ao dia. Isso ajuda a manter a constância e evita que a leitura se torne algo tedioso.</p>
        <p class="descricao-meta"><b>Dica 3: Tudo ao seu tempo</b></p>
    ...
    },
    {
        ...
        descricao:`<p class="descricao-meta"><b>1. Percy Jackson e os Olimpianos</b></p>
                <p class="descricao-meta">Percy Jackson e os Olimpianos é uma série de livros escrita por Rick Riordan. A história segue Percy Jackson, um adolescente que descobre ser um semideus, filho de (vai ter que ler :P). Ele é levado ao Acampamento Meio-Sangue, um refúgio para outros semideuses, onde aprende sobre sua verdadeira identidade e missão. Pra quem curte mitologia grega, isso aqui é uma sobremesa!</p>
                <p class="descricao-meta"><b>2. A Metamorfose</b></p>
                <p class="descricao-meta">A Metamorfose de Franz Kafka narra a história de Gregor Samsa, um jovem vendedor que, ao acordar certa manhã, descobre que se transformou em um inseto monstruoso. Incapaz de continuar sua vida normal, Gregor enfrenta a repulsa e o medo de sua família, que gradualmente se afasta dele.</p>
                <p class="descricao-meta"><b>3. A Hipótese do Amor</b></p>
                <p class="descricao-meta">A Hipótese do Amor de Ali Hazelwood é um romance que segue Olive Smith, uma estudante de doutorado que finge estar em um relacionamento com Adam Carlsen, um professor severo, para ajudar sua amiga. O plano é simples: convencer sua amiga de que ela está bem após um término. No entanto, à medida que Olive e Adam passam mais tempo juntos, a linha entre o que é real e o que é fingido começa a se confundir.</p>
